...
const NAV = [
  ...
  { href: "/app/coordenadores", label: "Coordenadores", icon: "🏛️", roles: ["super_admin", "admin"] as Role[] },
  ...
  { href: "/app/usuarios", label: "Usuários", icon: "👥", roles: ["super_admin", "admin", "coordinator"] as Role[] },
  { href: "/app/auditoria", label: "Auditoria", icon: "🛡️", roles: ["super_admin", "admin"] as Role[] },
];
